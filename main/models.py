...
class CharacterEquipment(CommonModel):
    ...
    right_hand = models.ForeignKey("cat.Weapon", on_delete=models.CASCADE, related_name="eqpmt_right_hand",
                                   null=True, blank=True)
    ring = models.ForeignKey("cat.Accessory", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                             null=True, blank=True)
    brace = models.ForeignKey("cat.Accessory", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                              null=True, blank=True)
    head = models.ForeignKey("cat.Armor", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                             null=True, blank=True)
    chest = models.ForeignKey("cat.Armor", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                              null=True, blank=True)
    bottom = models.ForeignKey("cat.Armor", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                               null=True, blank=True)
    belt = models.ForeignKey("cat.Accessory", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                             null=True, blank=True)
    foot = models.ForeignKey("cat.Armor", on_delete=models.CASCADE, related_name="eqpmt_left_hand",
                             null=True, blank=True)
